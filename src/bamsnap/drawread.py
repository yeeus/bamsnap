...
class DrawRead():
    ...
    def __init__(self, a, refseq=""):  # a:alignment
        ...
        if self.base_qual == None:
            #self.base_qual = '~'*len(self.readseq_with_softclipped)
    ...
    def draw_del(self, dr, y1, start, end):
        ...
        for gpos in self.del_list:
            ...
            if gpos[0] not in range(start, end) or gpos[1] not in range(start, end): continue
            #print('del for pass:', start, end, gpos[0], gpos[1])
